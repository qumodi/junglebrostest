...
public class MainMenuShopItems : MonoBehaviour
{
    ...
    void Update()
    {
        livesTxt.text = Localisation.GetString("LivesShop") + PlayerPrefs.GetInt(GlobalValue.Lives, 10);
        bulletTxt.text = Localisation.GetString("BuletsShop") + PlayerPrefs.GetInt(GlobalValue.Bullets, 3);
    }
